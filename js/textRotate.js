...
var theForm = document.getElementById( 'theForm' );
      ...
      new stepsForm( theForm, {
        onSubmit : function( form ) {
          ...
          var link="https://docs.google.com/forms/d/e/1FAIpQLScO_0LimH3VOpFgXngVZV_aHuKwUL4plNa2ZQLbQ90YF4UhKA/formResponse";
          jQuery.ajax({
                url: link,
                data: {"entry.1103944991" : $("#q2").val() , "entry.1876346618" : $("#q3").val() , "entry.504720242" : $("#q1").val() },
                type: "POST",
                dataType: "xml",
                crossDomain:true,
                statusCode: {
      ...
      function numberAnimations() {
        $(window).scroll(function() {
          if ($(".numbers-wrapper").is(":visible") == true) {
            ...
            $("#rendered-pixels").animateNumber({ number: 30178359, numberStep: comma_separator_number_step }, 2000);
            $("#coffee-cups").animateNumber({ number: 256, numberStep: comma_separator_number_step }, 2000);
            $("#eaten-nutela").animateNumber({ number: 3, numberStep: comma_separator_number_step }, 2000);
